...
import OurStory from '@/app/assets/img/mbBg.webp'
...
export default function HeroSectionMobile() {
    return (
        <div className='bg-[#f0f8ff]'>
            ...
            <div className="relative flex flex-col md:flex-row w-full mx-auto max-w-7xl  md:mt-24 rounded-lg overflow-hidden">
                

                {/* Content Section */}
                <div className="md:w-1/2 p-4 py-32">
                    <h2 className="font-display text-4xl font-bold tracking-normal text-[#202020] sm:text-7xl">
                        Welcome to

                    </h2>
                    <h2
                        className="font-display text-4xl  tracking-normal text-[#01600C] sm:text-7xl mt-4"
                    >

                        <span className="inline-block font-bold">
                            <span className="relative whitespace-nowrap text-[#01600C]">
                                ...
                                <span className="relative pl-5">  AR Group.</span></span>
                        </span>
                    </h2>

                    <h2 className=" mt-8 text-xl line-clamp-3 md:line-clamp-none text-[#202020] leading-loose  max-w-lg">
                        Empowering Industries with Architectural,
                        Technological,  and Interior Excellence.
                    </h2>
                    <p className=" mt-4 text-lg  md:line-clamp-none text-[#202020] leading-loose max-w-lg  ">
